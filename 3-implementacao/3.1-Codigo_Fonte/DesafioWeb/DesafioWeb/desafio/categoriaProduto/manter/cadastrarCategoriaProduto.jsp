    ...
    <body>
        <div class="container">
            ...
            <h1 class="title">Categoria Produto</h1>
             ...
             <netui:form tagId="formAlterarCategoriaProduto" action="acCadastrarCategoriaProduto">
                <h3 class="subtitle">Nome Categoria Produto</h3>
                <netui:textBox tagId="nome_categoria_produto" dataSource="{pageFlow.categoriaProdutoFormBean.categoriaProdutoVO.nome_categoria_produto}" maxlength="144"/>
                
                <netui:anchor formSubmit="true" action="acAbrirPopupVincularSubCategoria">
            ...
            <netui:form tagId="formDesvincularSubCategoria" action="acDesvincularSubCategoria">
                <netui:hidden tagId="codigo" dataSource="{pageFlow.categoriaProdutoFormBean.idCategoriaProdutoFiltro}" />
            </netui:form>
            
            <netui:form tagId="formVincularSubCategoria" action="acApagarMesagem">
                <netui:hidden tagId="displayPopup" dataSource="{pageFlow.categoriaProdutoFormBean.displayPopup}" />
                <netui:hidden tagId="mensagem" dataSource="{pageFlow.categoriaProdutoFormBean.mensagem}" />
            </netui:form>
            
            <netui-data:repeater dataSource="{pageFlow.listaSubCategoriaVOFiltrada}" defaultText="Nenhum Resultado Encontrado" ignoreNulls="true">
                ...
                <netui-data:repeaterItem>
                        <tr class="grid-tr-data">
                            ...
                            <td class="right-td-data">
                                <netui:anchor href="javascript:desvinculaSubCategoria({container.item.id_categoria_produto});">
            ...
            <div id="vinculaSubCategoriaModal" class="modal">
                <div class="modal-content">
                    ...
                    <netui-data:grid dataSource="{pageFlow.listaSubCategoria}" name="{pageFlow.gridListaSubCategoria}">
                        ...
                        <netui-data:pager renderInHeader="false" action="acPaginacaoSubCategoria" renderInFooter="true" pageSize="5"/>
                        <netui-data:columns filterAction="acFiltroLisstaSubCategoria" sortAction="acOrdenaListaSubCategoria">
                            <netui-data:anchorColumn action="acVinculaSubCategoria" addRowId="true" title="Nome Sub-categoria" name="NOME_CATEGORIA_PRODUTO"/>
                        </netui-data:columns>
                    </netui-data:grid>
        ...
        <script type="text/javascript">
            ...
            function desvinculaSubCategoria(codigo){
                forme = document.forms[getNetuiTagName("formDesvincularSubCategoria", this)];
                forme[getNetuiTagName("codigo",this)].value = codigo;
                forme.submit();
            }
               
            function abrirPopup(){
                forme = document.forms[getNetuiTagName("formVincularSubCategoria", this)];
            ...
            btnConfirma.onclick = function(){
                document.forms[getNetuiTagName("formAlterarCategoriaProduto", this)].submit();
        }
        </script>
    </body>
</netui:html>