 ...
 *                ejb-name = "CategoriaProdutoBean" data-source-name =
 *                "dsDesafio" table-name = "CATEGORIA_PRODUTO" prim-key-class =
 *                "java.lang.Long"
 *
 * @ejbgen:jndi-name local = "ejb.DesafioEjbs.CategoriaProdutoBeanHome"
 *
 * @ejbgen:file-generation local-class = "true" local-class-name =
 *                         "CategoriaProduto" local-home = "true"
 *                         local-home-name = "CategoriaProdutoHome" remote-class
 *                         = "false" remote-class-name =
 *                         "CategoriaProdutoRemote" remote-home = "false"
 *                         remote-home-name = "CategoriaProdutoRemoteHome"
 *                         value-class = "false" value-class-name =
 *                         "CategoriaProdutoValue" pk-class = "true"
 * @ejbgen:relation role-name=
 *                  "CategoriaProdutoBean-has-ProdutoCategoriaProdutoBeans"
 *                  target-ejb="ProdutoCategoriaProdutoBean" multiplicity="One"
 *                  name="ProdutoCategoriaProdutoBean-CategoriaProdutoBean"
 * @ejbgen:relation role-name="CategoriaProdutoBeans-have-CategoriaProdutoBean"
 *                  fk-column="ID_CATEGORIA_PAI" cmr-field="categoriaPai"
 *                  target-ejb="CategoriaProdutoBean" multiplicity="Many"
 *                  name="CategoriaProdutoBean-CategoriaProdutoBean"
 * @ejbgen:relation role-name="CategoriaProdutoBean-has-CategoriaProdutoBeans"
 *                  target-ejb="CategoriaProdutoBean" multiplicity="One"
 *                  name="CategoriaProdutoBean-CategoriaProdutoBean"
 * @ejbgen:automatic-key-generation cache-size="1" name="CATEGORIA_PRODUTO_SEQ"
 *                                  type="Oracle"
 */

public abstract class CategoriaProdutoBean extends GenericEntityBean {
	/**
	...
	/**
	 * Método executado depois da execução do ejbcreate for chamado
	 */
	...
	public void setData(CategoriaProdutoVO categoriaProdutoVO) throws DesafioException {
		this.setNome_categoria_produto(categoriaProdutoVO.getNome_categoria_produto() == null ? null
				: categoriaProdutoVO.getNome_categoria_produto().trim());
	}
	...
	public CategoriaProdutoVO getData() throws DesafioException {
		...
		categoriaProdutoVO.setId_categoria_produto(
				this.getId_categoria_produto() == null ? 0 : this.getId_categoria_produto().longValue());
		categoriaProdutoVO
				.setId_categoria_pai(this.getId_categoria_pai() == null ? 0 : this.getId_categoria_pai().longValue());
	...
	public void validaCategoriaProduto(CategoriaProdutoVO categoriaProdutoVO) throws DesafioException {
		if ((categoriaProdutoVO == null) || (categoriaProdutoVO.getNome_categoria_produto() == null)
