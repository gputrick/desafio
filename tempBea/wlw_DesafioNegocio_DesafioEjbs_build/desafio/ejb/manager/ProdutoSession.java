  ...
  implements SessionBean
{
  ...
  public void ejbCreate() { }
    ...
    /**
    * M�todo responsável pelo carregamento do Bean principal (master) em vari�veis globais
    * 
    * @param produtoVO
    ...
    */
     ...
     private ProdutoCategoriaProduto inicializaProdutoCategoriaProduto (ProdutoCategoriaProdutoVO produtoCategoriaProdutoVO) throws DesafioException, EJBException {
		...
		try {
                ...
                (produtoCategoriaProdutoVO.getCategoriaProduto().getId_categoria_produto() > 0)){
                    ...
                    //Chave Composta
                    ProdutoCategoriaProdutoBeanPK produtoCategoriaProdutoPK = new ProdutoCategoriaProdutoBeanPK(new Long(produtoCategoriaProdutoVO.getCategoriaProduto().getId_categoria_produto()),
     ...
     * @ejbgen:remote-method transaction-attribute="Required"
     */
     public ProdutoVO addProdutoCategoriaProduto(ProdutoCategoriaProdutoVO produtoCategoriaProdutoVO, ProdutoVO produtoVO)  throws DesafioException {
        ProdutoCategoriaProduto produtoCategoriaProduto = null;
        ProdutoCategoriaProdutoHome produtoCategoriaProdutoHome = null;
     ...
     * @ejbgen:remote-method transaction-attribute="Required"
     */
     public void delProdutoCategoriaProduto(ProdutoCategoriaProdutoVO produtoCategoriaProdutoVO, ProdutoVO produtoVO)  throws DesafioException {
        try{
            /*
			 * busca o produto
			 */
