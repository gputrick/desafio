    ...
    */
    private void inicializa(CategoriaProdutoVO categoriaProdutoVO) throws DesafioException {
        ...
        try {
            ...
            (categoriaProdutoVO.getId_categoria_produto() > 0)){
                
                this.categoriaProduto = this.categoriaProdutoHome.findByPrimaryKey(new Long(categoriaProdutoVO.getId_categoria_produto()));
