...
public final class ProdutoBean_jhfb8g__WebLogic_CMP_RDBMS_produtoCategoriaProdutoBean_produto_Set implements RDBMSSet, Set, Serializable,Cloneable
{
  // =================================================================
  // Class  variable(s)
...
private RDBMSPersistenceManager __WL_pm;
  ...
  private desafio.ejb.geral.ProdutoBean_jhfb8g_Intf __WL_creator;



  public ProdutoBean_jhfb8g__WebLogic_CMP_RDBMS_produtoCategoriaProdutoBean_produto_Set(desafio.ejb.geral.ProdutoBean_jhfb8g_Intf __WL_creator,
...
__WL_cache = __WL_bm.localWrapperSetFinder(__WL_finder, new Object[] {__WL_createPk});
  ...
  public Iterator iterator() {
    ...
    return new ProdutoBean_jhfb8g__WebLogic_CMP_RDBMS_produtoCategoriaProdutoBean_produto_Iterator(__WL_cache.iterator(), this);
  }
  ...
  public boolean add(Object o) {
    ...
    try {
      ...
      try {
        ...
        if (__WL_createPk.equals(__WL_bean.getId_produto())) {
          return false;
        }
        else {
          __WL_bean.setProduto(
            (desafio.ejb.geral.Produto)__WL_createEo);
          return true;
        }
      } finally {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ProdutoBean_jhfb8g__WebLogic_CMP_RDBMS_produtoCategoriaProdutoBean_produto_Set))
      return false;

    ProdutoBean_jhfb8g__WebLogic_CMP_RDBMS_produtoCategoriaProdutoBean_produto_Set other = (ProdutoBean_jhfb8g__WebLogic_CMP_RDBMS_produtoCategoriaProdutoBean_produto_Set)o;
    ...
    try {
      ...
      try {
        ...
        if (!__WL_createPk.equals(__WL_bean.getId_produto())) {
          ...
          __WL_bean.__WL_setProduto(null, ejbStore, remove);
          return true;
        }
      } finally {
        __WL_bean.__WL_setMethodState(__WL_oldState);
  ...
  public Object[] toArray(Object[] a)
  {
    ...
    if (a==null)
      throw new ArrayStoreException(
        "Null argument passed to ProdutoBean_jhfb8g__WebLogic_CMP_RDBMS_produtoCategoriaProdutoBean_produto_Set.toArray");
        ...
        if (i==0) {
          ...
          if (!toClass.isAssignableFrom(colClass)) {
            throw new ArrayStoreException(
              "Argument type '" +
              toClass.getName() +
              "' passed to ProdutoBean_jhfb8g__WebLogic_CMP_RDBMS_produtoCategoriaProdutoBean_produto_Set.toArray " +
  ...
  private void checkTransaction()
  {
    ...
    if (tx==null) {
      Loggable l = EJBLogger.logaccessedCmrCollectionOutsideTransactionLoggable("ProdutoBean", "produtoCategoriaProdutoBean_produto");
      throw new IllegalStateException(
        l.getMessage());
    }
    if (!tx.equals(__WL_createTx) && ! false ) {

      Loggable l1 = EJBLogger.logaccessedCmrCollectionInDifferentTransactionLoggable("ProdutoBean", "produtoCategoriaProdutoBean_produto");
      throw new IllegalStateException(
        l1.getMessage());
    }
  }
