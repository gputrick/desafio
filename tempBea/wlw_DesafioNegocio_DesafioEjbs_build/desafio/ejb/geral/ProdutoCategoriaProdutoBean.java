 ...
 *
 * @ejbgen:file-generation local-class = "true" local-class-name = "ProdutoCategoriaProduto" local-home = "true" local-home-name = "ProdutoCategoriaProdutoHome" remote-class = "false" remote-class-name = "ProdutoCategoriaProdutoRemote" remote-home = "false" remote-home-name = "ProdutoCategoriaProdutoRemoteHome" value-class = "false" value-class-name = "ProdutoCategoriaProdutoValue" pk-class = "true"
 * @ejbgen:relation role-name="ProdutoCategoriaProdutoBeans-have-CategoriaProdutoBean" fk-column="ID_CATEGORIA_PRODUTO" cmr-field="categoriaProduto" target-ejb="CategoriaProdutoBean" multiplicity="Many" name="ProdutoCategoriaProdutoBean-CategoriaProdutoBean"
 * @ejbgen:relation role-name="ProdutoCategoriaProdutoBeans-have-ProdutoBean" fk-column="ID_PRODUTO" cmr-field="produto" target-ejb="ProdutoBean" multiplicity="Many" name="ProdutoCategoriaProdutoBean-ProdutoBean"
 */

public abstract class ProdutoCategoriaProdutoBean 
  extends GenericEntityBean
{

  public desafio.ejb.geral.ProdutoCategoriaProdutoBeanPK ejbCreate(ProdutoCategoriaProdutoVO produtoCategoriaProdutoVO)
  ...
  public void ejbPostCreate(ProdutoCategoriaProdutoVO produtoCategoriaProdutoVO) 
    ...
    */
    public ProdutoCategoriaProdutoVO getData() throws DesafioException {
        ...
        (this.getCategoriaProduto().getId_categoria_produto().longValue() > 0)){
            ...
            produtoCategoriaProdutoVO.getCategoriaProduto().setId_categoria_produto(this.getId_categoria_produto().longValue());
        }    
        
        if((this.getProduto() != null) &&
        (this.getProduto().getId_produto().longValue() > 0)){
