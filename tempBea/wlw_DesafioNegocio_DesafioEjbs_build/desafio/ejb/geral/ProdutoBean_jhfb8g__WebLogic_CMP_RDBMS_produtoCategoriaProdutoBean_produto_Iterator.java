...
public class ProdutoBean_jhfb8g__WebLogic_CMP_RDBMS_produtoCategoriaProdutoBean_produto_Iterator implements Iterator {

  private EloWrapper currWrapper = null;
  private Iterator __WL_iter;
  private ProdutoBean_jhfb8g__WebLogic_CMP_RDBMS_produtoCategoriaProdutoBean_produto_Set __WL_creator;
  private Transaction __WL_createTx;

  public ProdutoBean_jhfb8g__WebLogic_CMP_RDBMS_produtoCategoriaProdutoBean_produto_Iterator(Iterator __WL_iter,
                            ProdutoBean_jhfb8g__WebLogic_CMP_RDBMS_produtoCategoriaProdutoBean_produto_Set __WL_creator) 
  {
  ...
  private void checkTransaction()
  {
    ...
    if (tx==null) {
      Loggable l = EJBLogger.logaccessedCmrIteratorOutsideTransactionLoggable("ProdutoBean", "produtoCategoriaProdutoBean_produto");
      throw new IllegalStateException(
        l.getMessage());
    }

    if (!tx.equals(__WL_createTx) && ! false ) {
      Loggable l1 = EJBLogger.logaccessedCmrIteratorInDifferentTransactionLoggable("ProdutoBean", "produtoCategoriaProdutoBean_produto");
