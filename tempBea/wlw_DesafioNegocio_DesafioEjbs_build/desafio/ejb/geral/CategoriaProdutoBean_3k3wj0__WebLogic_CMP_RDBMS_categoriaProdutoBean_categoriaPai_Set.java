...
public final class CategoriaProdutoBean_3k3wj0__WebLogic_CMP_RDBMS_categoriaProdutoBean_categoriaPai_Set implements RDBMSSet, Set, Serializable,Cloneable
{
  // =================================================================
  // Class  variable(s)
...
private RDBMSPersistenceManager __WL_pm;
  ...
  public CategoriaProdutoBean_3k3wj0__WebLogic_CMP_RDBMS_categoriaProdutoBean_categoriaPai_Set(desafio.ejb.geral.CategoriaProdutoBean_3k3wj0_Intf __WL_creator,
...
__WL_cache = __WL_bm.localWrapperSetFinder(__WL_finder, new Object[] {__WL_createPk});
  ...
  public Iterator iterator() {
    ...
    return new CategoriaProdutoBean_3k3wj0__WebLogic_CMP_RDBMS_categoriaProdutoBean_categoriaPai_Iterator(__WL_cache.iterator(), this);
  }
  ...
  public boolean add(Object o) {
    ...
    if (!(o instanceof desafio.ejb.geral.CategoriaProduto))
      throw new IllegalArgumentException(
        "Attempted to add an object of type '" +
        o.getClass().getName() +
        "' to collection, but the type must be '" +
        "desafio.ejb.geral.CategoriaProduto' instead.");
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          Loggable l = EJBLogger.logbeanDoesNotExistLoggable("CategoriaProdutoBean",eo.getPrimaryKey().toString());
          throw new IllegalArgumentException(l.getMessage());  
        }
        if (__WL_createPk.equals(__WL_bean.getId_categoria_pai())) {
          return false;
        }
        else {
          __WL_bean.setCategoriaPai(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof CategoriaProdutoBean_3k3wj0__WebLogic_CMP_RDBMS_categoriaProdutoBean_categoriaPai_Set))
      return false;

    CategoriaProdutoBean_3k3wj0__WebLogic_CMP_RDBMS_categoriaProdutoBean_categoriaPai_Set other = (CategoriaProdutoBean_3k3wj0__WebLogic_CMP_RDBMS_categoriaProdutoBean_categoriaPai_Set)o;
    ...
    try {
      ...
      try {
        ...
        if (!__WL_createPk.equals(__WL_bean.getId_categoria_pai())) {
          ...
          __WL_bean.__WL_setCategoriaPai(null, ejbStore, remove);
          return true;
        }
      } finally {
        __WL_bean.__WL_setMethodState(__WL_oldState);
  ...
  public Object[] toArray(Object[] a)
  {
    ...
    if (a==null)
      throw new ArrayStoreException(
        "Null argument passed to CategoriaProdutoBean_3k3wj0__WebLogic_CMP_RDBMS_categoriaProdutoBean_categoriaPai_Set.toArray");
    ...
    try {
      ...
      while (iter.hasNext()) {
        EloWrapper wrap = (EloWrapper)iter.next();
        desafio.ejb.geral.CategoriaProduto elem = 
          (desafio.ejb.geral.CategoriaProduto)wrap.getEJBLocalObject();
        ...
        if (i==0) {
          ...
          if (!toClass.isAssignableFrom(colClass)) {
            throw new ArrayStoreException(
              "Argument type '" +
              toClass.getName() +
              "' passed to CategoriaProdutoBean_3k3wj0__WebLogic_CMP_RDBMS_categoriaProdutoBean_categoriaPai_Set.toArray " +
  ...
  private void checkTransaction()
  {
    ...
    if (tx==null) {
      Loggable l = EJBLogger.logaccessedCmrCollectionOutsideTransactionLoggable("CategoriaProdutoBean", "categoriaProdutoBean_categoriaPai");
      throw new IllegalStateException(
        l.getMessage());
    }
    if (!tx.equals(__WL_createTx) && ! false ) {

      Loggable l1 = EJBLogger.logaccessedCmrCollectionInDifferentTransactionLoggable("CategoriaProdutoBean", "categoriaProdutoBean_categoriaPai");
      throw new IllegalStateException(
        l1.getMessage());
    }
  }
