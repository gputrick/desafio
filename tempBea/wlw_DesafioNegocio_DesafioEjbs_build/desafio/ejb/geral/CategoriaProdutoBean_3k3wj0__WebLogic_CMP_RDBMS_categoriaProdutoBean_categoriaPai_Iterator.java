...
public class CategoriaProdutoBean_3k3wj0__WebLogic_CMP_RDBMS_categoriaProdutoBean_categoriaPai_Iterator implements Iterator {

  private EloWrapper currWrapper = null;
  private Iterator __WL_iter;
  private CategoriaProdutoBean_3k3wj0__WebLogic_CMP_RDBMS_categoriaProdutoBean_categoriaPai_Set __WL_creator;
  private Transaction __WL_createTx;

  public CategoriaProdutoBean_3k3wj0__WebLogic_CMP_RDBMS_categoriaProdutoBean_categoriaPai_Iterator(Iterator __WL_iter,
                            CategoriaProdutoBean_3k3wj0__WebLogic_CMP_RDBMS_categoriaProdutoBean_categoriaPai_Set __WL_creator) 
  {
  ...
  private void checkTransaction()
  {
    ...
    if (tx==null) {
      Loggable l = EJBLogger.logaccessedCmrIteratorOutsideTransactionLoggable("CategoriaProdutoBean", "categoriaProdutoBean_categoriaPai");
      throw new IllegalStateException(
        l.getMessage());
    }

    if (!tx.equals(__WL_createTx) && ! false ) {
      Loggable l1 = EJBLogger.logaccessedCmrIteratorInDifferentTransactionLoggable("CategoriaProdutoBean", "categoriaProdutoBean_categoriaPai");
